...
const [predictedPlace , setPredictedPlace] = useState([])
    return(
        ...
        <div>
        <CustomButton className={style.btn} buttonText="Login" />
        <CustomButton className={style.btnSign} buttonText="Sign up"/>
        </div>
     ...
     <SearchBar setPredictedPlace={setPredictedPlace}/>
        ...
        <h4>Ahmedabad Bangalore Chennai Delhi Gurgaon Hyderabad Kolkata <br/> Mumbai Pune & more.</h4>
        </div>
