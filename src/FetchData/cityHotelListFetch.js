async function cityHotelListFetch(value) {  //after clicking on predicted place fetch data after place fetch
    console.log(value,"i m selectd place")
  
const res = await fetch(`https://www.swiggy.com/dapi/misc/address-recommend?place_id=${value.place_id}`)
...
console.log(latitude,"geo")
  ...
  console.log(fetchData.data?.cards[2].data?.data?.cards , "restaurant data allHotelData")
